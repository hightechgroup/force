...
//            
            ...
            container.Register<IQuery<ProductFilterParam, PagedResponse<ProductDto>>, EfMapsterQuery<ProductFilterParam, ProductDto>>(
                Lifestyle.Scoped);

            container.Register<IQuery<int, ProductDto>, ProductDtoQuery>(
                Lifestyle.Scoped);
            ...
            container.Register(typeof(IHandler<,>), typeof(SomeHandler<,>), Lifestyle.Scoped);
            
            container.RegisterConditional(
                typeof(IQuery<,>), typeof(ResultQuery<,>),
                Lifestyle.Scoped,
                c => !c.Handled
